...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_move', (
            ...
            ('computer', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('space', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'core', ['Move'])
    ...
    models = {
        ...
        u'core.move': {
            ...
            'computer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
