...
DIRNAME = os.path.basename(SITE_ROOT).join('//')
...
MEDIA_URL = os.path.join(DIRNAME, 'media/').replace('\\', '/')

# URL prefix for admin media -- CSS, JavaScript and images. Make sure to use a
# trailing slash.
# Examples: "http://foo.com/media/", "/media/".
ADMIN_MEDIA_PREFIX = os.path.join(DIRNAME, 'admin-media/').replace('\\', '/')

# Make this unique, and don't share it with anybody.
SECRET_KEY = '#(w8h01172-8do2$%sz#*ydf=&2@hfdw&_8113kh0!5uyfi$i@'
